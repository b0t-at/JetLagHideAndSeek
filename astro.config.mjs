    ...
    integrations: [
        ...
        AstroPWA({
            manifest: {
                ...
                icons: [
                    {
                        src: "https://jetlag.b0t.at/JLIcon.png",
                        sizes: "1080x1080",
                        type: "image/png",
                    },
                    {
                        src: "https://jetlag.b0t.at/android-chrome-192x192.png",
                        sizes: "192x192",
                        type: "image/png",
                    },
                    {
                        src: "https://jetlag.b0t.at/android-chrome-512x512.png",
                        sizes: "512x512",
                        type: "image/png",
                    },
                ],
